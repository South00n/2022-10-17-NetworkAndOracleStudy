 ...
 *    												     문장		 파일
 *    		   ------------------------------------
 *				  id	  pwd	   name   ===> 구분자 (컬럼) => 멤버변수 in java
 *    		   ------------------------------------
 *    			 aaa	  1234		홍길동 ===> record, row, tuple (튜플 여러개 카디널리티)
 *    		   ------------------------------------
 *    			 bbb	  1234		박문수
 *    		   ------------------------------------
 *    			 ccc	  1234		심청이
 ...
 *    			emp
 *    			----------------------------------------------------------
 *				empno   ename   job   mgr   hiredat   sal   comm   deftno
 *				사번	    이름     직위   사수   입사일     급여	성과긊	부서번호    		
 *    			----------------------------------------------------------
 *    
 *    		   오라클의 명령어 (SQL)
 *    		   ------------------
 ...
 *    								  Sequence(자동 증가번호), Index(검색, SORT), PS/SQL
 *    				 => 저장공간 수정 ==> ALTER
 *    				 => 저장공간 삭제 ==> DROP
 *    				 => 잘라내기 ==> TRUNCATE
 *    				 => 테이블명 변경 => RENAME
...
public class MainClass_Oracle {
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 */
			while(rs.next()) { // cursor위치를 맨위로 이동
